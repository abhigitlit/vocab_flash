...
def get_font(font_name, size):
    try:
        # Try Strategy 1: Relative to this script
        ...
        # If anything breaks, Log it and use Default. DO NOT CRASH.
        print(f"FONT CRASH ERROR: {str(e)}")
        return ImageFont.load_default()
...
def create_vocab_card_bytes(data, output_filename="vocab_card_modified.png"):
    ...
    # FONTS
    try:
        title_font = ImageFont.truetype("arialbd.ttf", s(125))
        pos_font = ImageFont.truetype("ariali.ttf", s(57))
        little_pos_font = ImageFont.truetype("ariali.ttf", s(45))
        body_font = ImageFont.truetype("arial.ttf", s(48))
        bold_body_font = ImageFont.truetype("arialbd.ttf", s(48))
        header_font = ImageFont.truetype("arialbd.ttf", s(42))
        small_font = ImageFont.truetype("arial.ttf", s(35))
